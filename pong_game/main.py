...
turtle.listen()
turtle.onkeypress(right_paddle.go_up, "Up")
turtle.onkeypress(right_paddle.go_down, "Down")
turtle.onkeypress(left_paddle.go_up, "w")
turtle.onkeypress(left_paddle.go_down, "s")
